...
const CreativeServicesSection = () => {
  ...
  return (
    ...
    >
      {/* HEADING */}
      <div className="absolute top-0 left-0 z-10 pt-2 pb-8 px-4">
        <h2 className="text-4xl sm:text-5xl md:text-6xl font-semibold px-24 text-center text-gray-700 whitespace-nowrap">
      ...
      <div className="sticky top-0 h-screen flex items-center justify-center px-4">
        <div
          className="relative w-full max-w-6xl h-[420px]"
                ...
                >
                  <div className="flex flex-col lg:flex-row gap-6 h-full">
                    ...
                    <div className="flex-1">
                      ...
                      <button className="flex items-center gap-2 bg-white/20 px-5 py-2 rounded-full hover:bg-white/30 transition">
